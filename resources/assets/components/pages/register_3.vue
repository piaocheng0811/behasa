<template>
    <vue-form v-if = "counter === 3" :state="formstate" @submit.prevent="onSubmit2(4)">
        ...
        <div  class="panel panel-info" >
            ...
            <div class="panel-body r-content">
                <div class="form-group">
                    <validate tag="div">
                        <input name="profile_image" type="file" class="form-control" id="profile_image" required>
                        <field-messages name="profile_image" show="$invalid && $submitted" class="text-danger">
                            <div slot="required">Profile Image is a required field</div>
                        </field-messages>
                    </validate>
                </div>
