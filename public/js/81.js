...
var update = __webpack_require__(39)("788fb592", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-71f9f548\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./users.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-71f9f548\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./users.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(39)("61b9f452", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-71f9f548\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./users.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-71f9f548\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./users.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.datatable-context[data-v-71f9f548]{\n    border:none;\n    padding: 0px !important;\n    margin-top: 20px;\n}\n.datatable-context[data-v-71f9f548]:hover{\n    box-shadow: none;\n}\n.datatable-material[data-v-71f9f548]{\n    display: flex;\n    flex-direction: column;\n    position: relative;\n    width: 100%;\n    margin: 30px 0;\n    overflow: unset;\n    box-shadow: 0 1px 4px 0 rgba(0,0,0,.14);\n    border-radius: 6px;\n    background: #fff;\n    font-family: \"Helvetica Neue\", Roboto, Arial, \"Droid Sans\", sans-serif;\n    font-size: 13px;\n    font-weight: 500;\n    color: #333333;\n    border: none;\n}\n.card-icon[data-v-71f9f548]{\n    border-radius: 3px;\n    padding: 8px 16px;\n    margin-top: -37px;\n    display: flex;\n    float: left;\n    box-shadow: 0 4px 20px 0 rgba(0,0,0,.14), 0 7px 10px -5px rgba(255,152,0,.4);\n    /*background: linear-gradient(60deg,#9c27b0,#9c27b0);*/\n    background: linear-gradient(60deg,#ec407a,#d81b60);\n}\n.card-icon p[data-v-71f9f548]{\n    margin-bottom: 0px;\n    font-size: 14px;\n    margin-left: 4px;\n    color: white;\n}\n.display-icon[data-v-71f9f548]{\n    color: whitesmoke;\n    font-size: 18px;\n}\n.student-btn[data-v-71f9f548]{\n\n    color: white;\n    background-color: #1769ff;\n    font-size: 11px;\n}\n.supervisor-btn[data-v-71f9f548]{\n\n    color: white;\n    background-color: #9c27b0;\n    font-size: 11px;\n}\n.admin-btn[data-v-71f9f548]{\n\n    color: white;\n    background-color: #4caf50;\n    font-size: 11px;\n}\n.card[data-v-71f9f548]{\n    box-shadow:none;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_awesome_swiper__ = __webpack_require__(856);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__ = __webpack_require__(807);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_tables_2__ = __webpack_require__(860);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_plugins_DataTable_DataTable__ = __webpack_require__(832);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_plugins_DataTable_DataTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_plugins_DataTable_DataTable__);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__["a" /* default */].init();
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_awesome_swiper___default.a);
var unsub;


__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_3_vue_tables_2__["ClientTable"], {}, false);
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "users",
    components: {
        datatable: __WEBPACK_IMPORTED_MODULE_4__components_plugins_DataTable_DataTable___default.a
    },
    data: function data() {
        return {
            usersData: [],
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__["a" /* default */].post('GetUsers').then(function (result) {
            var data = result.data;
            if (data.success) {
                console.log(data.usersData);
                _this.usersData = data.usersData;
                _this.usersData.forEach(function (item, index) {
                    _this.$set(item, 'key', index + 1);
                    var temp = '';
                    if (item.status == 0) temp = '<p style = "color: red;">inactive</p>';else temp = '<p  style = "color: black;">active</p>';
                    _this.$set(item, 'status', temp);

                    _this.$set(item, 'studentId', item.studentId);
                    var isAdmin = '';
                    if (item.isAdmin == 0) isAdmin = '<button class="btn btn-primary action-button student-btn btn-sm" style="  width: 122px;">Student</button>';else if (item.isAdmin == 1) isAdmin = '<button class="btn btn-success action-button admin-btn btn-sm" style="      width: 122px;">Admin</button>';else isAdmin = '<button class="btn btn-warning action-button supervisor-btn btn-sm" style="      width: 122px;">Supervisor</button>';

                    _this.$set(item, 'isAdmin', isAdmin);
                    _this.$set(item, 'name', item.name);
                    _this.$set(item, 'email', item.email);
                    var photo = '<h5 style="margin-bottom: 0">No Image</h5>';
                    if (item.photo == '') photo = '<img class="logo-image" src="http://localhost/vuejs-laravel/public/images/profile/avatar.png" style="width: 32px; height: 32px; border-radius:3px; " alt="No Image">';else photo = '<img class="logo-image" src="' + item.photo + '" style="width: 32px; height: 32px; border-radius:3px; " alt="No Image">';
                    _this.$set(item, "photo", photo);
      ...
      [
        _c(
          ...
          [
            _c(
              "router-link",
              { staticClass: "nav-link", attrs: { to: "/admin/users/create" } },
              [
                _c("div", { staticClass: "card-icon" }, [
                  _c("i", { staticClass: "fa fa-user-plus display-icon" }),
                  _vm._v(" "),
                  _c("p", [_vm._v("Add User")])
                ])
              ]
            ),
            _vm._v(" "),
            _c("datatable", {
              staticClass: "datatable-context",
              attrs: { title: "", rows: _vm.usersData, columns: _vm.columndata }
            })
          ],
          1
        )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-71f9f548", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-71f9f548"
...
Component.options.__file = "resources/assets/components/pages/admin/users.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-71f9f548", Component.options)
  } else {
    hotAPI.reload("data-v-71f9f548", Component.options)
  }
