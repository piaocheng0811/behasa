...
var update = __webpack_require__(39)("42467c1a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4345b224\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./category.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4345b224\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./category.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(39)("1f9825f6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4345b224\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./category.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4345b224\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./category.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.datatable-context[data-v-4345b224]{\n    border:none;\n    padding: 0px !important;\n    margin-top: 20px;\n}\n.datatable-context[data-v-4345b224]:hover{\n    box-shadow: none;\n}\n.datatable-material[data-v-4345b224]{\n    display: flex;\n    flex-direction: column;\n    position: relative;\n    width: 100%;\n    margin: 30px 0;\n    overflow: unset;\n    box-shadow: 0 1px 4px 0 rgba(0,0,0,.14);\n    border-radius: 6px;\n    background: #fff;\n    font-family: \"Helvetica Neue\", Roboto, Arial, \"Droid Sans\", sans-serif;\n    font-size: 13px;\n    font-weight: 500;\n    color: #333333;\n    border: none;\n}\n.card-icon[data-v-4345b224]{\n    border-radius: 3px;\n    padding: 8px 16px;\n    margin-top: -37px;\n    display: flex;\n    float: left;\n    box-shadow: 0 4px 20px 0 rgba(0,0,0,.14), 0 7px 10px -5px rgba(255,152,0,.4);\n    background: linear-gradient(60deg,#ec407a,#d81b60);\n}\n.card-icon p[data-v-4345b224]{\n    margin-bottom: 0px;\n    font-size: 14px;\n    margin-left: 4px;\n    color: white;\n}\n.display-icon[data-v-4345b224]{\n    color: whitesmoke;\n    font-size: 18px;\n}\n.card[data-v-4345b224]{\n    box-shadow:none;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__["a" /* default */].post('GetCategories').then(function (result) {
            var data = result.data;
            if (data.success) {
                console.log(data.CategoryData);
                _this.CategoryData = data.CategoryData;
        ...
        action: function action(newVal) {
            ...
            if (newVal.id != null) {
                ...
                if (this.model.action == 1) {
                    __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__["a" /* default */].post('ChangeCategoryStatus', this.model).then(function (result) {
                        var data = result.data;
    ...
    methods: {
        read: function read() {
            ...
            __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__["a" /* default */].post('GetCategories').then(function (result) {
                ...
                if (data.success) {
                    console.log(data.CategoryData);
                    _this3.CategoryData = data.CategoryData;
                    _this3.CategoryData.forEach(function (item, index) {
                        _this3.$set(item, 'key', index + 1);
                        _this3.$set(item, 'name', item.name);
                        var temp = '';
                        var status = '';
                        if (item.status == 0) {
                            temp = '<p style = "color: red;">inactive</p>';
                        ...
                        _this3.$set(item, 'status', temp);
                        _this3.$set(item, 'action', status);
                    });
                }
            }, function (error) {
                console.log('error');
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "card-icon" }, [
                  _c("i", { staticClass: "fa fa-cog display-icon" }),
                  _vm._v(" "),
                  _c("p", [_vm._v("Add Category")])
                ])
              ]
            ),
            _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4345b224", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-4345b224"
...
Component.options.__file = "resources/assets/components/pages/admin/category.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4345b224", Component.options)
  } else {
    hotAPI.reload("data-v-4345b224", Component.options)
  }
