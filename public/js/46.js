        ...
        __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__["a" /* default */].post('GetUsers').then(function (result) {
            ...
            if (data.success) {
                ...
                _this.usersData.forEach(function (item, index) {
                    ...
                    if (item.photo == '') photo = '<img class="logo-image" src="resources/assets/assets/img/avatar.png" style="width: 32px; height: 32px; border-radius:3px; " alt="No Image">';else photo = '<img class="logo-image" src="' + item.photo + '" style="width: 32px; height: 32px; border-radius:3px; " alt="No Image">';
