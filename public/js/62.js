...
var update = __webpack_require__(39)("78cc519e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7806180e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./admin_login.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7806180e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./admin_login.vue");
...
// module
exports.push([module.i, "\n.login-content[data-v-7806180e] {\n    margin-top: 7%;\n    margin-bottom: 7%;\n    box-shadow: 0 0 20px #ccc;\n    background-size: 100% 100%;\n    border-radius: 7px;\n}\n.img_backgrond[data-v-7806180e]{\n    background-image: url(" + escape(__webpack_require__(994)) + ");\n    background-size:cover;\n    background-repeat:no-repeat;\n    width: 100%;\n    padding: 75px 15px;\n}\nlabel[data-v-7806180e]{\n    font-size: 14px !important;\n}\n[data-v-7806180e]::-webkit-input-placeholder {\n    font-size:14px;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_admin_api_service__ = __webpack_require__(807);
//
//
//
//
...
__WEBPACK_IMPORTED_MODULE_3__common_admin_api_service__["a" /* default */].init();
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            if (this.formstate.$invalid) {
                ...
                __WEBPACK_IMPORTED_MODULE_3__common_admin_api_service__["a" /* default */].post('login', this.model).then(function (result) {
                    var data = result.data;
                    if (data.success) {
                        _this.$store.dispatch('adminLogin', data.data);
                        _this.$store.commit('changeAdmin', data.data);
      ...
      _c("div", { staticClass: "col-sm-12" }, [
        _c("div", { staticClass: "text-center" }, [
          _c("img", {
            ...
            attrs: { src: __webpack_require__(1735) }
          })
        ])
      ])
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7806180e", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-7806180e"
...
Component.options.__file = "resources/assets/components/pages/admin_login.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7806180e", Component.options)
  } else {
    hotAPI.reload("data-v-7806180e", Component.options)
  }
