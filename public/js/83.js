...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(39)("4bc1f1c1", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8bf53424\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./edit-user.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8bf53424\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./edit-user.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.row[data-v-8bf53424] {\n    padding: 10px;\n}\n.mb-3[data-v-8bf53424]{\n    margin-bottom: 0px !important;\n}\n.user-register[data-v-8bf53424]{\n    display: flex;\n    justify-content: center;\n}\n.user-register button[data-v-8bf53424]{\n    font-size: 12px;\n}\n.nav-tabs .nav-link.active[data-v-8bf53424] {\n    color: #333 !important;\n    border-color: #9c27b0 !important;\n}\n.admin-registration[data-v-8bf53424] {\n    width: 296.667px;\n    transform: translate3d(-8px, 0px, 0px);\n    transition: all 0.5s cubic-bezier(0.29, 1.42, 0.79, 1) 0s;\n    background-color: #e91e63;\n    box-shadow: 0 4px 20px 0 rgba(0, 0, 0, .14), 0 7px 10px -5px rgba(233, 30, 99, .4);\n    position: absolute;\n    text-align: center;\n    padding: 12px;\n    font-size: 12px;\n    text-transform: uppercase;\n    -webkit-font-smoothing: subpixel-antialiased;\n    top: -6px;\n    left: 0;\n    border-radius: 4px;\n    color: #fff;\n    cursor: pointer;\n    font-weight: 500;\n}\n#wizardProfile[data-v-8bf53424] {\n    padding: 20px;\n}\n.card[data-v-8bf53424] {\n    box-shadow: none;\n}\n/*--------------*/\nh2[data-v-8bf53424] {\n    font-family: \"Roboto\", sans-serif;\n    font-size: 26px;\n    line-height: 1;\n    color: #454cad;\n    margin-bottom: 0;\n}\np[data-v-8bf53424] {\n    font-family: \"Roboto\", sans-serif;\n    font-size: 18px;\n    color: #5f6982;\n}\n.text-center[data-v-8bf53424]{\n    padding: 20px;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_cropperjs__ = __webpack_require__(858);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cropperjs_dist_cropper_css__ = __webpack_require__(1037);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__validations_validations__ = __webpack_require__(805);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            model: {
                ...
                profile_image: "",
                gender: "A",
                options: [{ item: 'B', name: 'Male' }, { item: 'B', name: 'Female' }],
                married: 'a',
                married_options: [{ value: 'a', text: 'Single' }, { value: 'b', text: 'Married' }],
                category: '1',
                CategoryData: [],
                userType: '1',
                userType_options: [{ userType_item: '1', userType_name: 'Admin' }, { userType_item: '0', userType_name: 'Student' }]
            }
        };
    },
    ...
    methods: {
        ...
        EditUser: function EditUser() {
            ...
            console.log('------------end');
            __WEBPACK_IMPORTED_MODULE_8__common_admin_api_service__["a" /* default */].post('EditUser', this.model).then(function (result) {
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_8__common_admin_api_service__["a" /* default */].get('ViewUser/' + this.id).then(function (result) {
            var data = result.data;
            if (data.success) {
                console.log('userData', data.userData[0]);
                _this3.userData = data.userData[0];
            } else {
                console.log(data);
            }
        }, function (error) {
                ...
                _c("b-card", [
                  _c("div", { staticClass: "row" }, [
                    _c(
                      ...
                      [
                        _c("vue-form", { attrs: { state: _vm.formstate } }, [
                          _c("div", { staticClass: "table-responsive" }, [
                            _c(
                              ...
                              [
                                _c("tbody", [
                                  _c("tr", [
                                    _vm.userData.isAdmin == 1
                                      ? _c("td", { staticClass: "text-left" }, [
                                          _vm._v("Admin ID")
                                        ])
                                      : _vm.userData.isAdmin == 0
                                      ? _c("td", { staticClass: "text-left" }, [
                                          _vm._v("Student ID")
                                        ])
                                      : _c("td", { staticClass: "text-left" }, [
                  ...
                  _c("input", {
                    ...
                    on: {
                      input: function($event) {
                        ...
                        _vm.$set(_vm.model, "isAdmin = 1", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8bf53424", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-8bf53424"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/components/pages/admin/edit-user.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8bf53424", Component.options)
  } else {
    hotAPI.reload("data-v-8bf53424", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
